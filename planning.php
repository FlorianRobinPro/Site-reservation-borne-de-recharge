...
<?php    
       ...
       $reqnbfoisutili = "SELECT res_utili FROM creneau WHERE reserver = TRUE AND res_utili ='".$username."'";
       $resultnbfoisutili = $db->query($reqnbfoisutili);
       $nbfoisutili = $resultnbfoisutili->num_rows;

       $reqjourreseverve = "SELECT jour FROM creneau WHERE reserver = TRUE AND res_utili ='".$username."'";
       $resultjourreseverve = $db->query($reqjourreseverve);
       $jourreseverve = $resultjourreseverve -> fetch_assoc();


//        if ($datelundiS1<=$jourreseverve && $jourreseverve<= $datevendrediS1){
//     if($nbfoisutili >= 3){  
//     echo '<script language="javascript">alert("Vous avez réservé un maximum de trois créneaux cette semaine !")</script>';
//    }
//     else{
...
// if ($datelundiS2<=$jourreseverve && $jourreseverve<= $datevendrediS2){
//     if($nbfoisutili >= 3){  
//     echo '<script language="javascript">alert("Vous avez réservé un maximum de trois créneaux cette semaine !")</script>';
//    }
//     else{
...
<tr>
    ...
    <?php
         ...
         if($data = mysqli_fetch_array($resultreqlundiCR1) == FALSE){
           ...
           if ($heure > $heureCR1 && $date == $datelundiS1){
               echo "<td style='background-color:grey;'><div>Plus Réservabe</div></td>";
           }
           else if ($date > $datelundiS1){
               echo "<td style='background-color:grey;'><div>Plus Réservable</div></td>";
           }
          else{
            echo "<td name='creneau1' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datelundiS1."&creneau=".$creneau1."&username=".$username."&heure=".$heureCR1."'?> Libre </a> </td>";
         }
          }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
        }
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmardiCR1) == FALSE){
            ...
            echo "<td name='creneau1' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemardiS1."&creneau=".$creneau1."&username=".$username."&heure=".$heureCR1."'?> Libre </a> </td>";
           }
         }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmercrediCR1) == FALSE){
            ...
            echo "<td name='creneau1' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemercrediS1."&creneau=".$creneau1."&username=".$username."&heure=".$heureCR1."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqjeudiCR1) == FALSE){
            ...
            echo "<td name='creneau1' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datejeudiS1."&creneau=".$creneau1."&username=".$username."&heure=".$heureCR1."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
        ...
        <?php 
         ...
         if($data = mysqli_fetch_array($resultreqvendrediCR1 ) == FALSE){
            ...
            echo "<td name='creneau1' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datevendrediS1."&creneau=".$creneau1."&username=".$username."&heure=".$heureCR1."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
...
<tr>
    <td>10h à 13h</td>
        <?php 
         ...
         if($data = mysqli_fetch_array($resultreqlundiCR2) == FALSE){
            ...
            echo "<td name='creneau2' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datelundiS1."&creneau=".$creneau2."&username=".$username."&heure=".$heureCR2."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmardiCR2) == FALSE){
            ...
            echo "<td name='creneau2' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemardiS1."&creneau=".$creneau2."&username=".$username."&heure=".$heureCR2."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmercrediCR2) == FALSE){
            ...
            echo "<td name='creneau2' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemercrediS1."&creneau=".$creneau2."&username=".$username."&heure=".$heureCR2."''?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqjeudiCR2) == FALSE){
            ...
            echo "<td name='creneau2' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datejeudiS1."&creneau=".$creneau2."&username=".$username."&heure=".$heureCR2."''?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqvendrediCR2) == FALSE){
            ...
            echo "<td name='creneau2' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datevendrediS1."&creneau=".$creneau2."&username=".$username."&heure=".$heureCR2."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
...
<tr>
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqlundiCR3) == FALSE){
            ...
            echo "<td name='creneau3' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datelundiS1."&creneau=".$creneau3."&username=".$username."&heure=".$heureCR3."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmardiCR3) == FALSE){
            ...
            echo "<td name='creneau3' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemardiS1."&creneau=".$creneau3."&username=".$username."&heure=".$heureCR3."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmercrediCR3) == FALSE){
            ...
            echo "<td name='creneau3' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemercrediS1."&creneau=".$creneau3."&username=".$username."&heure=".$heureCR3."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqjeudiCR3) == FALSE){
            ...
            echo "<td name='creneau3' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datejeudiS1."&creneau=".$creneau3."&username=".$username."&heure=".$heureCR3."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqvendrediCR3) == FALSE){
            ...
            echo "<td name='creneau3' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datevendrediS1."&creneau=".$creneau3."&username=".$username."&heure=".$heureCR3."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
...
<tr>
    <td>16h à 19h</td>
        ...
        if($data = mysqli_fetch_array($resultreqlundiCR4) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datelundiS1."&creneau=".$creneau4."&username=".$username."&heure=".$heureCR4."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
        ...
        if($data = mysqli_fetch_array($resultreqmardiCR4) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemardiS1."&creneau=".$creneau4."&username=".$username."&heure=".$heureCR4."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
        ...
        if($data = mysqli_fetch_array($resultreqmercrediCR4) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemercrediS1."&creneau=".$creneau4."&username=".$username."&heure=".$heureCR4."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
        ...
        if($data = mysqli_fetch_array($resultreqjeudiCR4) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datejeudiS1."&creneau=".$creneau4."&username=".$username."&heure=".$heureCR4."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
        ...
        if($data = mysqli_fetch_array($resultreqvendrediCR4) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datevendrediS1."&creneau=".$creneau4."&username=".$username."&heure=".$heureCR4."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
...
<tr>
    ...
    <?php 
        ...
        if($data = mysqli_fetch_array($resultreqlundiSVCR1) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datelundiS2."&creneau=".$creneau1."&username=".$username."&heure=".$heureCR1."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
        ...
        <?php 
         ...
         $resultreqmardiSVCR1 = mysqli_query($db, $reqmardiSVCR1);
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemardiS2."&creneau=".$creneau1."&username=".$username."&heure=".$heureCR1."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmercrediSVCR1) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemercrediS2."&creneau=".$creneau1."&username=".$username."&heure=".$heureCR1."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
                if($data = mysqli_fetch_array($resultreqjeudiSVCR1) == FALSE){
                    ...
                    echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datejeudiS2."&creneau=".$creneau1."&username=".$username."&heure=".$heureCR1."'?> Libre </a> </td>";
                    }
                }
                else{
                    echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqvendrediSVCR1) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datevendrediS2."&creneau=".$creneau1."&username=".$username."&heure=".$heureCR1."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
...
<tr>
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqlundiSVCR2) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datelundiS2."&creneau=".$creneau2."&username=".$username."&heure=".$heureCR2."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmardiSVCR2) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemardiS2."&creneau=".$creneau2."&username=".$username."&heure=".$heureCR2."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmercrediSVCR2) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemercrediS2."&creneau=".$creneau2."&username=".$username."&heure=".$heureCR2."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqjeudiSVCR2) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datejeudiS2."&creneau=".$creneau2."&username=".$username."&heure=".$heureCR2."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqvendrediSVCR2) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datevendrediS2."&creneau=".$creneau2."&username=".$username."&heure=".$heureCR2."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
...
<tr>
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqlundiSVCR3) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datelundiS2."&creneau=".$creneau3."&username=".$username."&heure=".$heureCR3."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmardiSVCR3) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemardiS2."&creneau=".$creneau3."&username=".$username."&heure=".$heureCR3."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmercrediSVCR3) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemercrediS2."&creneau=".$creneau3."&username=".$username."&heure=".$heureCR3."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqjeudiSVCR3) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datejeudiS2."&creneau=".$creneau3."&username=".$username."&heure=".$heureCR3."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqvendrediSVCR3) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datevendrediS2."&creneau=".$creneau3."&username=".$username."&heure=".$heureCR3."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
...
<tr>
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqlundiSVCR4) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datelundiS2."&creneau=".$creneau4."&username=".$username."&heure=".$heureCR4."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmardiSVCR4) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemardiS2."&creneau=".$creneau4."&username=".$username."&heure=".$heureCR4."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqmercrediSVCR4) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datemercrediS2."&creneau=".$creneau4."&username=".$username."&heure=".$heureCR4."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqjeudiSVCR4) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datejeudiS2."&creneau=".$creneau4."&username=".$username."&heure=".$heureCR4."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
    ...
    <?php 
         ...
         if($data = mysqli_fetch_array($resultreqvendrediSVCR4) == FALSE){
            ...
            echo "<td name='creneau4' id='creneau'> <a style='text-decoration:none; color:black;' href='validation1.php?jour=".$datevendrediS2."&creneau=".$creneau4."&username=".$username."&heure=".$heureCR4."'?> Libre </a> </td>";
            }
        }
        else{
            echo "<td style='background-color:red;'><div>Réservé</div></td>";
